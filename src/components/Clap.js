...
const withClapAnimation = (WrappedComponent) => {
  class WithClapAnimation extends Component {
    ...
    componentDidMount() {
      ...
      const countlAnimation = new mojs.Html({
          el: "#clapCount",
          opacity: {0:1},
          duration: tlDuration,
          y: {0: -30},
...
const triagleBruts = new mojs.Burst({
    parent:"#clap",
    radius: {50:95},
    count: 5,
    angle: 30,
...
const circleBurst = new mojs.Burst({
    ...
    children:{
      ...
      const counTotalAnimation = new mojs.Html({
        el: "#clapCountTotal",
        opacity: { 0: 1 },
      ...
      const newAnimtionTimeline = this.animationTimeline.add([
        scaleButton,
        counTotalAnimation,
        countlAnimation,triagleBruts,
        circleBurst
      ]);
      this.setState({ animationTimeline: newAnimtionTimeline });
    }
    render() {
      return (
        <WrappedComponent
